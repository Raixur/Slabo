...
namespace VRTK
{
    ...
    public class VRTK_AvatarHandController : MonoBehaviour
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            interactTouch = interactTouch ?? GetComponentInParent<VRTK_InteractTouch>();
            interactGrab = interactGrab ?? GetComponentInParent<VRTK_InteractGrab>();
            interactUse = interactUse ?? GetComponentInParent<VRTK_InteractUse>();
        }
        ...
        {
            for (var i = 0; i < fingerUntouchedAxis.Length; i++)
            {
        ...
        {
            var isUsing = (interactUse != null && interactUse.GetUsingObject() != null);
            var overrideValues = (GetOverrideValues((isUsing ? useOverrides : grabOverrides)));
            var overrideFingerAxis = (isUsing ? GetOverrideValues(grabOverrides) : fingerAxis);
        ...
        {
            var isGrabbing = (interactGrab != null && interactGrab.GetGrabbedObject() != null);
            var overrideFingerAxis = (isGrabbing ? GetOverrideValues(grabOverrides) : fingerAxis);
        ...
        {
            return overrideType == AxisOverrides.ApplyOverrideType.Always ||
